...
{
    var $table = 'adm_process';
    var $primary_key = 'adm_process_id';
    var $column_order = array(null,'adm_process_name',null);
    var $column_search = array('adm_process_id', 'adm_process_name');
    var $order = array('adm_process_id' => 'asc');
    ...
    public function get_list_parent($limit = FALSE, $offset = FALSE) {
        ...
        if ($limit) {
            return $this->db->where("adm_process_id is null")->limit($limit, $offset)->get()->result();
        } else {
