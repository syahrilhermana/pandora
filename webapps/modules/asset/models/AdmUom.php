...
class AdmUom extends CI_Model
{
    var $table = 'adm_uom';
    var $primary_key = 'adm_uom_id';
    var $column_order = array(null, 'adm_uom_code', 'adm_uom_name', null);
    var $column_search = array('adm_uom_name', 'adm_uom_code');
    var $order = array('adm_uom_id' => 'asc');
